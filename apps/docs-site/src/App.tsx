        ...
        <div className="mx-auto grid max-w-[1160px] grid-cols-[180px_minmax(0,820px)] justify-center gap-[60px] px-6 pt-[18px] pb-[110px] max-[960px]:grid-cols-1 max-[680px]:gap-[35px] max-[680px]:px-4 max-[680px]:pt-[15px] max-[680px]:pb-[75px]">
          ...
          <div className="min-w-0">
            <section className="py-[70px] first:border-t-0 border-t border-line max-[680px]:py-[55px]" id="install">
              ...
              <div className={CALLOUT}><Info className="mt-0.5 text-[#909aa5]" /><p className={CALLOUT_P}><strong className={CALLOUT_STRONG}>Billing reconciliation is optional.</strong> Start with one bounded monitoring-access check. Brolly shows the results first, then reveals OAuth reconnection or a prefilled, account-scoped Billing Read user-token form only if needed. A verified billing token is encrypted inside your D1. The next screen—not the access check—can fill editable limits from recent usage.</p></div>
            </section>
