        ...
        <div className="docs-layout">
          ...
          <div className="docs">
            <section id="install">
              ...
              <div className="callout"><Info /><p><strong>Billing reconciliation is optional.</strong> First verify Workers and Durable Object access, then reconnect Cloudflare if an OAuth permission is missing. For invoice-aligned daily costs, setup can verify a narrowly scoped Billing Read token and encrypt it inside your D1. The next screen—not the access check—can fill editable limits from recent usage.</p></div>
            </section>
